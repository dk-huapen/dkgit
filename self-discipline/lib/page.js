				...
				for (y in xjson){
					...
					objtr.appendChild(objtd);
						...
						if(xjson.management=='管理' && y=='management'){
							var objtd=document.createElement('td');
							text="<a href='look_"+xjson.action+".php?id="+id+"'><img border=0 src='../../images/info.png' alt='查看'></a>";
							text+="<a href='edit_"+xjson.action+".php?id="+id+"'><img border=0 src='../../images/edit.gif' alt='编辑'></a>";
							text+="<a href='del_"+xjson.action+".php?id="+id+"'><img border=0 src='../../images/del.gif' alt='删除'></a>";
