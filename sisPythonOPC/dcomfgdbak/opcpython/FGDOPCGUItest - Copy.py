...
def testVar():
    ...
    try:
        ...
        if testNumber == len(FGDlist):
            ...
            testVarButton['text'] = "测试通过"+str(testNumber)+"项/共"+str(len(FGDlist))+"项"
        if opcServer.OPCGroups:
            opcServer.OPCGroups.RemoveAll()
        ...
        print("erro:")
        print(testErro)
        testVarButton['text'] = "测试未通过"+str(testNumber)+"项/共"+str(len(FGDlist))+"项"
        if opcServer.OPCGroups:
            opcServer.OPCGroups.RemoveAll()
        if opcServer:
            opcServer.Disconnect()
...
def initOPC():
    ...
    try:
        ...
        if varNumber == len(FGDlist):
            ...
            initOPCButton['text'] = "初始化成功"+str(varNumber)+"项/共"+str(len(FGDlist))+"项"
        ...
        print("erro:")
        print(initErro)
        initOPCButton['text'] = "初始化失败"+str(testNumber)+"项/共"+str(len(FGDlist))+"项"
        if opcServer.OPCGroups:
            opcServer.OPCGroups.RemoveAll()
        if opcServer:
            opcServer.Disconnect()
