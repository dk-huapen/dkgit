	...
	<body>
		...
		<table>
			<tr>
				...
				<td valign=middle>
					<div id="status" style="width:250px;height:200px;">
						<p>该网页用来查询数据库历史曲线</p>
						<p>最多可以设置两个量程不同的y轴 </p>
		...
		echo "<fieldset>",
			//时间设置，查询，翻页画面
			"<legend>时间</legend>";
			echo "<label>查看数据时间段</label>";
			echo "<select id='SYSDB'style='width:20%' class='selectfont')>",
				"<option value='tanhecha'>本月数据</option>",
				"<option value='august2024'>2024年8月</option>";
                	echo "</select>";
			echo "数据库为";
			echo $begin_time;
			echo "到";
