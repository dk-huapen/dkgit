...
//$sql = "SELECT point_number,point_kks,point_description,point_type,point_cabinet,point_slot,module_type,point_channel,point_terminal,terminal_a,terminal_b,terminal_c FROM tb_point_table WHERE point_cabinet LIKE '%10cbb01%' order by point_number desc limit 10,10"; 
