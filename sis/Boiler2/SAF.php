<html>
	<head>
    		<title>2号炉密封风及火检冷却风系统</title>
		<?php include("../header.php")?>
	</head>
	<body>
		<?php include("top.php")?>
		<center><h1>2号炉密封风及火检冷却风系统</h1></center>
		<script>
			var page = 65;
			var test =<?php
			include('../conn.php');
			$sql="SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle,indexID,X,Y FROM sis where page=65 union SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle1,indexID,X1,Y1 FROM sis where page1=65 union SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle2,indexID,X2,Y2 FROM sis where page2=65";
