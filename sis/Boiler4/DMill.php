<html>
	...
	<body>
		<?php include("top.php")?>
		<center><h1>4号炉制粉系统D</h1></center>
		<script>
			var page = 157;
			var test =<?php
			include('../conn.php');
			$sql="SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle,indexID,X,Y FROM sis where page=157 union SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle1,indexID,X1,Y1 FROM sis where page1=157";
