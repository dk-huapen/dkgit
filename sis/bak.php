...
?>;
	...
	<svg width="500" height="500" viewBox="0 0 500 500" fill="gray">
		...
		<text id = "40HSA40CQ105" x="300" y="350" fill="black" font-size="20" font-family="Arial"onclick=click(this.id,5707) onmouseover=mOver(this.id,"4号炉脱硝反应器出口NH3逃逸") onmouseout=mOut() onmouseup=mUp(5707,this.id)>bad!</text>
<rect id = "10HBK10CP105"x="400" y="360" width="20" height="20" rx="5" ry="5" fill="gray" onclick=click(this.id,1813) onmouseover=mOver(this.id,"1号炉膛出口烟气压力低低停炉") onmouseout=mOut() onmouseup=mUp(1813,this.id)></rect>
<polygon id = "10HLA11AA001" points="250,250 250,300 350,250,350,300" fill="white" stroke="black" stroke-width="2" onclick=click(this.id,1132) onmouseover=mOver(this.id,"1号炉A送风机出口风门") onmouseout=mOut() onmouseup=mUp(1132,this.id)></polygon>
	</svg>
	<!--SIS最底部导航栏-->
<div class="btn-group">
