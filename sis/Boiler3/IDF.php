<html>
	...
	<body>
		<?php include("top.php")?>
		<center><h1>3号炉引风机本体系统</h1></center>
		<script>
			var page = 109;
			var test =<?php
			include('../conn.php');
			$sql="SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle,indexID,X,Y FROM sis where page=109 union SELECT kks,name,value,unit,updatetime,HH,H,HHH,L,LL,LLL,flag,angle1,indexID,X1,Y1 FROM sis where page1=109";
	...
	<!--SIS画面-->
		<svg width="1860" height="1000" viewBox="0 0 1860 1000" fill="gray">
			...
			?>
			<!--包含具体名称的元素-->
<text x="210" y="440" fill="black" font-size="25" font-family="Arial">引风机A</text>
<text x="1160" y="440" fill="black" font-size="25" font-family="Arial">引风机B</text>
<text x="330" y="80" fill="black" font-size="20" font-family="Arial">引风机急停</text>
<text x="330" y="110" fill="black" font-size="20" font-family="Arial">引风机故障</text>
<text x="330" y="140" fill="black" font-size="20" font-family="Arial">引风机就地</text>
<text x="280" y="170" fill="black" font-size="20" font-family="Arial">引风机停止(SOE)</text>
<text x="1280" y="80" fill="black" font-size="20" font-family="Arial">引风机急停</text>
<text x="1280" y="110" fill="black" font-size="20" font-family="Arial">引风机故障</text>
<text x="1280" y="140" fill="black" font-size="20" font-family="Arial">引风机就地</text>
<text x="1230" y="170" fill="black" font-size="20" font-family="Arial">引风机停止(SOE)</text>
